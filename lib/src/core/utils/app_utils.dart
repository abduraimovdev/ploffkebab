...
sealed class AppUtils {
  ...
  static EdgeInsets paddingAll16 = const EdgeInsets.all(16);
  static EdgeInsets paddingLeft16 = const EdgeInsets.only(left: 16);
  static EdgeInsets paddingRight16 = const EdgeInsets.only(right: 16);
  static EdgeInsets paddingBottom16 = const EdgeInsets.only(bottom: 16);
  static EdgeInsets paddingBottom40 = const EdgeInsets.only(bottom: 40);
  static EdgeInsets paddingTop16 = const EdgeInsets.only(top: 16);
  static EdgeInsets paddingSH16 = const EdgeInsets.symmetric(horizontal: 16);
  static EdgeInsets paddingSH10 = const EdgeInsets.symmetric(horizontal: 10);
  static EdgeInsets paddingSH16V10 = const EdgeInsets.symmetric(horizontal: 16, vertical: 10);
  static EdgeInsets paddingSH16V8 = const EdgeInsets.symmetric(horizontal: 16, vertical: 8);
  static EdgeInsets paddingSH16V12 = const EdgeInsets.symmetric(horizontal: 16, vertical: 12);
  static EdgeInsets paddingSH80V60 = const EdgeInsets.symmetric(horizontal: 80, vertical: 60);
