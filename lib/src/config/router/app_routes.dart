...
import 'package:ploff_kebab/src/presentation/pages/auth/confirm/confirm_code_page.dart';
import 'package:ploff_kebab/src/presentation/pages/auth/register/register_page.dart';
import 'package:ploff_kebab/src/presentation/pages/choose_lang/choose_lang_page.dart';
import 'package:ploff_kebab/src/presentation/pages/internet_connection/internet_connection_page.dart';
import 'package:ploff_kebab/src/presentation/pages/main/banner_detail/banner_detail_page.dart';
import 'package:ploff_kebab/src/presentation/pages/main/detail/detail_page.dart';
import 'package:ploff_kebab/src/presentation/pages/main/main_page.dart';
import 'package:ploff_kebab/src/presentation/pages/main/profile/about_us/about_us_page.dart';
import 'package:ploff_kebab/src/presentation/pages/main/profile/settings/settings_page.dart';
    ...
    GoRoute(
      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (context, state) => BannerDetailPage(
            banner: (state.extra!) as BannerModel,
          ),
        ),
      ],
    ),
