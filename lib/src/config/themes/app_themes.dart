...
final ThemeData lightTheme = appTheme.copyWith(
  ...
  iconTheme: const IconThemeData(color: Color(0xFF9AA6AC)),
  ...
  tabBarTheme: TabBarTheme(
    ...
    indicatorColor: const Color(0xFF2B2A28),
    labelColor: const Color(0xFF2B2A28),
    unselectedLabelColor: const Color(0xFF2B2A28),
